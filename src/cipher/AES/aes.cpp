...
std::string AES::encryptBlock(const std::string& data, std::string key)
{
...
std::string AES::decryptBlock(const std::string& data, std::string key)
{
...
// --- Inverse S-box ---
constexpr std::array<uint8_t, 256> AES::inv_sbox = {
